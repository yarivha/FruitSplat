...
//
//             fruit speed    wave 1    13    25    35    45    50
//             Easy             1.00  1.18  1.36  1.51  1.66  1.73
//             Medium           1.00  1.42  1.84  2.19  2.54  2.72
//             Hard             1.00  1.60  2.20  2.70  3.00  3.00
//
//         The ceilings are set just above what a 50-wave route actually reaches,
//         so the number on the mode button is close to the truth rather than a
//         limit nothing hits. They used to be 1.35/1.90/2.20, reached by wave 26,
//         after which the ramp stopped doing anything and a long run drifted
//         toward the player.
//
...
//         Easy 1.8.
//
//         The point of the table is that those rows are flat from wave 13 to the
//         end. They used to climb away — past wave 30 the game got steadily
//         easier, because a wave's demand is bounded and a player's bank is
//         not.
//
